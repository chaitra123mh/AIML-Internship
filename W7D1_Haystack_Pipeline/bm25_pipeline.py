...
if len(pdf_files) == 0:
    ...
    print("Make sure your PDF files are inside the documents folder.")
    exit()
...
print("\n")
print("=" * 70)
print("BM25 PIPELINE COMPLETED SUCCESSFULLY")
print("=" * 70)